...
int Actions :: call(ActionID id) try
{
  int index;
...
SELECT_TAB:
  ...
  case SEARCH_UP:   case SEARCH_DOWN:
  case SEARCH_PREV: case SEARCH_NEXT:
...
#define ACTIONS_HPP__GET_STRING(ENUM, STRING) STRING,
  ACTIONS_HPP__FOREACH_ACTION(ACTIONS_HPP__GET_STRING)
};
