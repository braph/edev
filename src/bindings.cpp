...
#define bind2(KMAP, K1, K2, ACTION) \
  bind1(KMAP, K1, ACTION); \
  bind1(KMAP, K2, ACTION)

#define bind3(KMAP, K1, K2, K3, ACTION) \
  bind1(KMAP, K1, ACTION); \
  bind1(KMAP, K2, ACTION); \
  bind1(KMAP, K3, ACTION)
...
bind2(browser,  127, KEY_BACKSPACE,                BACK                  );
