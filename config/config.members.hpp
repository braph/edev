...
extern PlayingInfoFormat playinginfo_format_top;
extern PlayingInfoFormat playinginfo_format_bottom;
extern PlayingInfoFormat playinginfo_format_top_256;
extern PlayingInfoFormat playinginfo_format_bottom_256;
extern std::vector<std::string> main_widgets;
extern std::vector<std::string> tabs_widgets;
